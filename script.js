...
const result = strings.filter(function (item) {
...
const sq = numbers.map(function (item) {
  return item * item;
});
console.log(sq);
...
const red = alphabets.reduce(function (final, index) {
  return final + index;
}, '');
console.log(red);
...
const e = number.find(function (item) {
  return item % 2 === 0;
});
console.log(e);
...
const fnd = ranks.findIndex(function (item) {
  return item === 7;
});
console.log(fnd);
...
const m = marks.some(function (item) {
  return item < 45;
});
console.log(m);
...
const ap = positive.every(function (element) {
  return element > 0;
});
console.log(ap);
